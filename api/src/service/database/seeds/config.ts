...
4. Please respond using a Texas tone and accent whenever possible.`,
  ...
  greetingMessage: `Howdy, partner! I'm your trusty AI farm hand, an ol' Texas cowboy through and through. Ain't nobody knows farmin' better'n me, y'hear?`,
}

export const quickActionConfig = `[{"key":0,"displayName":"🏠 Buy a farm","prompt":"I want buy a farm, give me some suggestions."},{"key":1,"displayName":"🐄 Buy some cows","prompt":"I want buy some cows, give me some suggestions."},{"key":3,"displayName":"💰 How to run a farm?","prompt":"How to run a farm? Please tell me in detail."}]`
...
export const intentSeed: Prisma.IntentUncheckedCreateWithoutBotIntentInput[] = [
  {
    ...
    intentHandler: {
      create: {
        type: 'MODELRESPONSE',
        guidelines: 
`1. At the end of each answer, add a paragraph as a promotion for a farm broker, with the following content, the format is markdown, the text is bold, and separated from other content by separators:
"""
